...
BOOST_PYTHON_MODULE(_chaste_project_Angiogenesis_vessel_auto){
    ...
    bp::class_< VasculatureGenerator< 3 > >( "VasculatureGenerator3", bp::init< >() )    
        ...
        .def( 
            ...
            , ( bp::arg("scale_factor")=200., bp::arg("num_increments")=(unsigned int)(40), bp::arg("a_param")=0.5, bp::arg("b_param")=1. ) )    
        .def( 
        ...
        .def( 
            ...
            , ( bp::arg("vesselLength")=100., bp::arg("divisions")=(unsigned int)(0), bp::arg("axis")=(unsigned int)(2) ) )
        .def( 
            ...
            , ( bp::arg("cubeX")=100., bp::arg("cubeY")=100., bp::arg("cubeZ")=100., bp::arg("numPoints")=(unsigned int)(400) ) )    
        .def( 

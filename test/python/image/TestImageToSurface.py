...
class TestImageToSurface(unittest.TestCase):
    ...
    def test_bio_2d(self):
        ...
        chaste.utility.readwrite.write(image, file_handler.GetOutputDirectoryFullPath() + "/original2d.vti")
        chaste.utility.readwrite.write(tool.output, file_handler.GetOutputDirectoryFullPath() + "/vtk_surface2d.vtp")

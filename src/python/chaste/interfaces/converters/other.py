...
def vtk_lines_to_polylines(boundary):
    
    """
    Take vtk lines in the form of polydata and merge lines between branch points into
    polylines
    @param boundary vtk polydata with lines
    @return vtk polydata with polylines between branch points
    """
